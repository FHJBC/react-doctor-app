  ...
  return (
        <div id="bio" className='lg:px-10 bg-slate-200 flex flex-col items-center justify-center lg:items-center lg:flex-row'>
            <div className='p-5 lg:w-1/2'>
                ...
                <p className='my-5 lg:text-2xl lg:w-96 lg:my-16 font-nunito-sans text-primary'>A gynecologist is a doctor who specializes in female reproductive health system.</p>
            ...
            <div className='p-10'>
                <p className='lg:text-xl text-justify font-nunito-sans text-primary'>A physician/doctor in the functions and diseases specific to women and girls, especially those affecting the reproductive system. Also known as Gynecology, these doctors collaborate with nurses, X-ray technicians, medical assistants, 
                    and other doctors (such as emergency room doctors and surgeons) for treatments.</p><br/>
                <p className='text-justify font-nunito-sans text-primary'>Dr. Denman is certified by the American Board in Internal Medicine and in hematology and medical Gynecology. He currently serves as a consultant in medical Gynecology at Medicenter Hospital and as the program director for the National Healthcare Group Medical
                    Oncology Residency Program, which is run in collaboration with Medicenter Hospital.</p><br/>
                <p className='text-justify font-nunito-sans text-primary'>Nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel euiriure dolor in hendrerit in vulputate velit esse molestie consequat,
